...
const PERMISSION = {
    ...
    'ai:getConfig': ['amministratore:ollama:view'],
    'ai:saveConfig': ['amministratore:ollama:edit'],
    'ai:getStatus': ['amministratore:ollama:test'],
    'ai:listModels': ['amministratore:ollama:view'],
    'ai:saveApiKey': ['amministratore:ollama:edit'],
    'ai:removeApiKey': ['amministratore:ollama:edit'],
    'ai:setJarvisState': ['amministratore:ollama:edit'],
    'ai:loadModel': ['amministratore:ollama:edit'],
    'ai:releaseModel': ['amministratore:ollama:edit'],
