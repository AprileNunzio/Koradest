...
const APP_ID = 'anagrafica';
const CARTELLA_MODULI = 'apps/anagrafica/subapps';
...
export default {
    render: async (el, params = {}) => {
        ...
        const renderHome = () => renderModuliHome(el, {
            ...
            sottotitolo: 'Documenti, contatti, residenza e dati del tuo profilo',
            icona: 'badge',
            tinta: 'acqua',
        ...
        const renderModulo = async (folder) => {
            ...
            try {
                ...
                console.error('[Profilo] Apertura del modulo non riuscita:', errore);
                punto.innerHTML = `
                    <div class="k-empty">
