            ...
            const renderAuthForm = () => {
                el.innerHTML = `
                    <div class="fade-in-up" style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; padding: 2rem;">
                        ...
                        <p style="color: var(--md-on-surface-variant); text-align: center; margin-bottom: 2rem; font-size: 1.1rem;">Il codice di sicurezza cifra tutti i dati della rete. Reinserisci il tuo PIN o la tua password per visualizzarlo.</p>
                        <div style="background: var(--md-surface-variant); padding: 2.5rem; border-radius: 20px; width: 100%; max-width: 450px; display: flex; flex-direction: column; gap: 1.5rem; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                                <label for="auth-password" style="font-weight: 600; color: var(--md-on-surface-variant); margin-left: 0.5rem;">PIN o password</label>
                                <input type="password" id="auth-password" class="input" autocomplete="current-password" placeholder="Il tuo PIN o la tua password..." style="width: 100%; padding: 1.2rem; border-radius: 12px; border: 1px solid var(--md-outline); background: var(--md-surface); color: var(--md-on-surface); font-size: 1.1rem; box-sizing: border-box;">
                                <span id="auth-error" style="display: none; color: var(--md-error); font-size: 0.9rem; font-weight: 600; margin-left: 0.5rem;"></span>
                            </div>
                ...
                const handleVerify = async () => {
                    ...
                    try {
                        ...
                        console.error('[Credenziali] Richiesta del codice non riuscita:', e);
                        mostraErrore('Richiesta del codice non riuscita.');
                    }
                    btn.innerHTML = 'Mostra il codice';
                    btn.disabled = false;
                    input.value = '';
                    input.focus();
                };
                        ...
                        " class="hover-scale">
                            ...
                            <div style="position: relative; z-index: 1;">
                                ...
                                <div style="
                                    ...
                                    position: relative;
                                ">
                                    <span id="network-code-display" style="font-family: 'Courier New', monospace; font-size: 2.8rem; font-weight: 800; letter-spacing: 4px; color: var(--md-primary); text-shadow: 0 2px 10px rgba(102, 126, 234, 0.2); user-select: all;"></span>
                                </div>
                                <div style="display: flex; justify-content: center; margin-top: 2rem;">
                                    <button id="btn-copy-code" class="btn hover-scale" style="
