...
const APP_ID = 'amministratore';
const CARTELLA_MODULI = 'apps/amministratore/subapps';
...
export default {
    render: async (el, params = {}) => {
        ...
        const renderHome = () => renderModuliHome(el, {
            ...
            sottotitolo: 'Utenti, ruoli, sicurezza e configurazione del nodo',
            icona: 'admin_panel_settings',
            tinta: 'indaco',
        ...
        const renderModulo = async (folder) => {
            ...
            try {
                ...
                console.error('[Amministratore] Apertura del modulo non riuscita:', errore);
                punto.innerHTML = `
                    <div class="k-empty">
